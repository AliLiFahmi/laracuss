        ...
        <nav class="navbar navbar-dark navbar-expand-lg bg-primary">
            <div class="container flex justify-content-between">
              <a class="navbar-link" href="{{ route('home') }}">
                <img class="h-32px" src="{{ url('assets/images/logo-width.png') }}" alt="Larscuss Logo">
              </a>
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
              </button>
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-0 mb-2 mx-lg-3">
                ...
                <form class="d-flex w-100 me-4 my-2 my-lg-0" role="search" action="#" method="GET">
                    <div class="input-group">
                        <span class="input-group-text bg-width border-end-0"><img src="{{ url('assets/images/magnifier.png') }}" alt="Search"></span>
                ...
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    <li class="nav-item ps-1 pe-0">
                        <a class="btn btn-primary-white" href="#">Sing Up</a>
                    </li>
                </ul>
              </div>
            </div>
          ...
          <section class="container hero">
            <div class="row align-item-center h-100">
                <div class="col-12 col-lg-6">
                    ...
                    <a href="" class="btn btn-primary me-2 mb-2 mb-lg-0">Sing Up</a>
